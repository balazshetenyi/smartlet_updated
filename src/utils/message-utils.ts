 ...
 */
const sendMessageEmailNotification = async (
    conversationId: string,
    senderId: string,
    messageContent?: string
): Promise<void> => {
...
export const sendMessage = async (
    ...
    try {
        ...
        // Send both push and email notifications (non-blocking)
        Promise.all([
            sendMessageNotification(data.conversation_id, data.sender_id, data.content),
            sendMessageEmailNotification(data.conversation_id, data.sender_id, data.content),
