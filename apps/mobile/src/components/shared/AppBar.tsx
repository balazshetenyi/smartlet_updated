...
export default function AppBar() {
  ...
  // Keep the badge count fresh whenever this screen is focused
  useFocusEffect(
    useCallback(() => {
  ...
  // Panel sits just below the AppBar: status bar + appbar height (≈56px)
  ...
  return (
    <>
      ...
      >
        <TouchableWithoutFeedback onPress={() => setPanelOpen(false)}>
                      ...
                      return (
                        <View
                          ...
                          style={[
                            ...
                            i < notifications.length - 1 && styles.itemDivider,
                          ]}
                        >
